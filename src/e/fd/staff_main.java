...
public class staff_main extends javax.swing.JFrame {
    ...
    String name, surname, initial, n, sr, in, branch, br, date;
    ...
    private void view() {
        ...
        b = br;
        try {
            String sql2 = "select * from staff_info where branch=?";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new Hod_E_FB_Result(br).setVisible(true);
