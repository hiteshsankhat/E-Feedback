 ...
 * @author hites
 */
public class change_password_princi extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql4 = "select * from PRINCIPAL_INFO where username=? and password=?";
            ...
            if (rs.next()) {
                String sql1 = "update PRINCIPAL_INFO set password=? where username=? ";
            ...
            Logger.getLogger(change_password_princi.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(change_password_princi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
